...
<div class="content">
    ...
    <div id="pageContent">
        ...
        <!--General Infor-->
        <div class="page_info">
            <p class="parHead">Protein-Drug 3D Interaction</p>
            <p class="parText">
                This report provides listing of atom-to-atom interactions between a protein of interest
                and a small drug molecule that have been documented in co-crystallization files retrieved from the RCSB PDB Protein Data Bank.
                In the second table, each row represents a unique interaction between an atom on the protein and an atom on the drug molecule.
                The distances between the atom pairs are meaured in Angstroms.
                Based on this data, the most important amino acid residuees involved in drug binding are identified in the first table.
            </p>
        </div>
